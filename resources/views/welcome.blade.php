...
<body class="h-screen bg-left bg-no-repeat bg-cover bg-[url('{{ asset('/images/welcome.png') }}')]">
                ...
                <div class="relative flex items-center justify-between h-20">
                    ...
                    <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                        <div class="flex-shrink-0 flex items-center">
                            <img class="h-12 w-auto sm:h-16 md:h-20" src="{{ asset('/images/logo.png') }}"
                                alt="logo">
                        </div>
                    </div>
                    {{-- Desktop menu --}}
            ...
            <div class="flex flex-col lg:flex-row w-full justify-between gap-8">
                ...
                <div class="w-full lg:w-1/2 md:w-1/2 flex flex-col items-center justify-center space-y-6">
                    ...
                    <div class="w-full sm:w-11/12 lg:w-2/3 bg-gray-100 rounded-2xl p-4 sm:p-6">
                        <h1
                            class="text-3xl sm:text-4xl lg:text-6xl font-bold tracking-tight bg-gradient-to-r from-red-700 to-blue-800 bg-clip-text text-transparent text-center">
                            DOCBOOK
                        </h1>
                        <p
                            class="mt-4 sm:mt-6 text-sm sm:text-md leading-6 sm:leading-8 text-red-900 text-justify px-2 sm:px-4">
                    ...
                    <!-- Action buttons -->
                    <div
                        class="w-full sm:w-11/12 lg:w-2/3 flex items-center justify-center gap-x-4 sm:gap-x-6 bg-gray-200 p-3 sm:p-4 rounded-2xl">
                        <a href="#"
                            class="rounded-md bg-blue-900 px-3 sm:px-4 py-2 text-sm font-semibold text-white shadow hover:bg-blue-800 transition-colors duration-200">
                            Get started
                        </a>
                        <a href="#"
                            class="text-sm font-semibold text-red-800 hover:text-red-900 transition-colors duration-200">
                            Learn more →
                        </a>
                    </div>
                </div>
                ...
                <div class="w-full lg:w-1/4 md:w-1/4 lg:h-2/3">
                    ...
                    <div class="lg:hidden md:hidden ml-8 flex flex-row justify-center gap-2 flex-wrap grid grid-cols-2 justify center mb-4">
                        <a href="#"
                            class=" w-1/2 text-center text-xs font-semibold text-blue-900 px-2 py-2 bg-gray-200 rounded-2xl hover:bg-red-900 hover:text-white transition-colors duration-200">
                            Services <span aria-hidden="true" class="te">&rarr;</span>
                        </a>
                        <a href="#"
                            class=" w-1/2 text-center text-xs font-semibold text-blue-900 px-2 py-2 bg-gray-200 rounded-2xl hover:bg-red-900 hover:text-white transition-colors duration-200">
                    ...
                    <div
                        class="hidden position absolute right-10 top-60 w-32 md:flex md:flex-col space-y-4 bg-gray-200 text-blue-900 text-center p-4 rounded-2xl">
                        <a href="#"
                            class="text-sm font-semibold px-2 py-2 hover:bg-red-900 hover:text-white rounded-2xl transition-colors duration-200">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-40">
